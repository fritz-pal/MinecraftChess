...
public class Board implements Cloneable {
    ...
    public Board(ActiveGame game, String fen) {
        this.game = game;
    ...
    public Board(ActiveGame game, Map<Vec2, Piece> pieces, boolean whiteTurn, Vec2 enCroissant, boolean whiteCastleQ, boolean whiteCastleK, boolean blackCastleQ, boolean blackCastleK) {
        this.game = game;
    ...
    public void move(Vec2 from, Vec2 to, boolean isMainBoard, PieceType promotion) {
        ...
        if (isMainBoard) {
            ...
            if (whiteTurn) whiteOfferedDraw = false;
            else blackOfferedDraw = false;
